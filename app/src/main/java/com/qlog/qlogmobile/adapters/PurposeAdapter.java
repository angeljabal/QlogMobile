...
public class PurposeAdapter extends RecyclerView.Adapter<PurposeAdapter.MultiViewHolder> implements Filterable {
    ...
    public PurposeAdapter(ArrayList<Purpose> purposes, Context context) {
